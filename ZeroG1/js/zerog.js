var zeroG = {
	initialize: function(){
		...
		var margin_bottom = "-" + logoHeight * 0.858;
 		TweenMax.to("#zg_logo", 2, {width:logoWidth,  height:logoHeight, display:"block", marginRight:margin_right, marginBottom:margin_bottom, 
	...
	performLogin: function(){
		var self = this;
		TweenMax.to("#centered_login", 0.5, {alpha:0, display:"none", ease:Power2.easeInOut, onComplete: self.showZLogoAnimation(self)});
	},
	showZLogoAnimation: function(context){
	...
	bindSplashEvents: function(){
		...
		//Firefox
		 ...
		 $("#arrows_btn").bind('click', function(e){
			 self.performSplashAnimation();
		 });	
	},
	unbindSplashEvents: function(){
		$(window).unbind('DOMMouseScroll');
		$(window).unbind('mousewheel');
	},
	performSplashAnimation: function(){
		this.unbindSplashEvents();	
